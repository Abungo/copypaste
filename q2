...
create table shipment(orderno int,warehouseno int,ship_date date,primary key(orderno,warehouseno),foreign key(orderno) references order(orderno),foreign key(warehouseno) references warehouse(warehouseno));
